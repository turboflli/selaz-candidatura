...
<body>
        <div class="container">
            ...
            <jsp:include page="modelistaForm.jsp" />
            ...
            <div  class= "field is-grouped">
                <div class="control has-icons-left">
                    <input type="submit" value="Enviar" class="input is-success" onclick="modelista.save()" />
                        <span class="icon is-small is-left">
                          <i class="fas fa-check-square"></i>
                        </span>
                </div>
                <div class="control ">
                    <button onclick="modelista.limpar()" class="button is-link is-light">Limpar</button>
                </div>
            </div>
