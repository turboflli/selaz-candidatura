...
<table class="table" id="tbl_exporttable_to_xls">
  ...
  <th><abbr title="Se o kit possui Temática">Temática</abbr></th>
              ...
              <th><abbr title="A classificação do modelo">Classificação</abbr></th>
              <th><abbr title="O Enquadramento do modelo">Enquadramento</abbr></th>
              <th><abbr title="A Nacionalidade do fabricante do modelo">Nacionalidade</abbr></th>
    ...
    <td>
        ...
        <c:if test = "${!kit.tematica}">
            ...
            <td>${fn:replace(kit.tipo,'auto','')}</td>
            <td>${kit.classificacao}</td>
            <td>${kit.enquadramento}</td>
            <td>${kit.nacionalidadeFab}</td>
